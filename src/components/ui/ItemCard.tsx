  ...
  return (
    <div className="relative w-[290px] h-[380px]">
      ...
      <div className="absolute bottom-0 top-30 left-0 w-full h-[340px] bg-secondary rounded-tr-[34px] rounded-bl-[34px]">
        ...
        {/* Add to Cart Button */}
        <button className="absolute -bottom-6 right-0 w-[140px] h-[45px] p-3 bg-primary hover:bg-[#234f3c] text-white text-base font-semibold flex items-center justify-center gap-[6px] rounded-tl-[20px] rounded-bl-[20px] rounded-br-[20px] transition-colors">
          Add to Cart
